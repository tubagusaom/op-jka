...
Asesor <?=$aplikasi->nama_unit?>
    ...
    <table style="width: 100%;" border="0" align="right">
        ...
        <?php
            ...
            <?php $ttd_asesor = $list_asesor->users . " - " . $list_asesor->no_reg . "\r\n\n\n" . $data['aplikasi']->url_aplikasi . "/qrcode/asesor";?>

                    
                        <tr>
                            <td style="width: 10%; text-align: left; padding: 2px; "><?=$key+1?>. <?=$list_asesor->users?></td>
                            <td style="width: 30%; padding: 2px; text-align: right;"><qrcode value="<?php echo $ttd_asesor; ?>" ec="Q" style="width: 15mm;"></qrcode></td></tr>
